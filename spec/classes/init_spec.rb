  ...
  describe 'using role' do
    describe 'client' do
      ...
      context 'with default configuration' do
        ...
        it do
          is_expected.to contain_cron('puppet_cron_interval').with({
            'ensure'  => 'present',
            'user'    => 'root',
      ...
      context 'with custom configuration' do
        ...
        context '[main]' do
          ...
          it do
            is_expected.to contain_ini_setting('/etc/puppetlabs/puppet/puppet.conf main certname').with({
              'section' => 'main',
              'setting' => 'certname',
              'value'   => facts[:fqdn],
          ...
          it do
            is_expected.to contain_ini_setting('/etc/puppetlabs/puppet/puppet.conf main server').with({
              'section' => 'main',
              'setting' => 'server',
          ...
          it do
            is_expected.to contain_ini_setting('/etc/puppetlabs/puppet/puppet.conf main ca_server').with({
              'section' => 'main',
              'setting' => 'ca_server',
        ...
        context '[agent]' do
          ...
          it do
            is_expected.to contain_ini_setting('/etc/puppetlabs/puppet/puppet.conf agent certname').with({
              'section' => 'agent',
              'setting' => 'certname',
              'value'   => facts[:fqdn],
              'path'    => '/etc/puppetlabs/puppet/puppet.conf',
          ...
          it do
            is_expected.to contain_ini_setting('/etc/puppetlabs/puppet/puppet.conf agent server').with({
              'section' => 'agent',
              'setting' => 'server',
              'value'   => 'puppet.tldr.domain.com',
              'path'    => '/etc/puppetlabs/puppet/puppet.conf',
          ...
          it do
            is_expected.to contain_ini_setting('/etc/puppetlabs/puppet/puppet.conf agent ca_server').with({
              'section' => 'agent',
              'setting' => 'ca_server',
              'value'   => 'puppetca.tldr.domain.com',
              'path'    => '/etc/puppetlabs/puppet/puppet.conf',
        ...
        context '[master]' do
          ...
          it do
            is_expected.to contain_ini_setting('/etc/puppetlabs/puppet/puppet.conf master certname').with({
              'section' => 'master',
              'setting' => 'certname',
              'value' => facts[:fqdn],
              'path' => '/etc/puppetlabs/puppet/puppet.conf',
          ...
          it do
            is_expected.to contain_ini_setting('/etc/puppetlabs/puppet/puppet.conf master server').with({
              'section' => 'master',
              'setting' => 'server',
              'value'   => 'puppet.tldr.domain.com',
              'path'    => '/etc/puppetlabs/puppet/puppet.conf',
          ...
          it do
            is_expected.to contain_ini_setting('/etc/puppetlabs/puppet/puppet.conf master ca_server').with({
              'section' => 'master',
              'setting' => 'ca_server',
              'value'   => 'puppetca.tldr.domain.com',
              'path'    => '/etc/puppetlabs/puppet/puppet.conf',
          ...
          var[:name].each do |var_name|
            ...
            var[:valid].each do |valid|
              context "when #{var_name} (#{type}) is set to valid #{valid} (as #{valid.class})" do
                ...
                it do
                  is_expected.to contain_ini_setting('/etc/puppetlabs/puppet/puppet.conf ' + var_name.sub(/conf_/, '') + ' setting1').with({
                    'setting' => 'setting1',
                    'value'   => 'the',
                  })
                end
                it do
                  is_expected.to contain_ini_setting('/etc/puppetlabs/puppet/puppet.conf ' + var_name.sub(/conf_/, '') + ' setting2').with({
                    'setting' => 'setting2',
                    'value'   => 'game',
                  })
                end
      ...
      describe 'with hiera_data' do
        describe 'and hiera_merge disabled' do
          context 'with data in a single level' do
            ...
            it do
              is_expected.to contain_ini_setting('/etc/puppetlabs/puppet/puppet.conf main ca').with({
                'section' => 'main',
                'setting' => 'ca',
                'value'   => 'false',
                'path'    => '/etc/puppetlabs/puppet/puppet.conf',
        ...
        describe 'and hiera_merge enabled' do
          ...
          context 'with data in multiple levels' do
            ...
            it do
              is_expected.to contain_ini_setting('/etc/puppetlabs/puppet/puppet.conf main vardir').with({
                'section' => 'main',
                'setting' => 'vardir',
                'value'   => '/dev/null',
                'path'    => '/etc/puppetlabs/puppet/puppet.conf',
    ...
    describe 'master' do
      ...
      context 'with fileserver configuration' do
        ...
        it do
          is_expected.to contain_ini_setting('/etc/puppetlabs/puppet/fileserver.conf files path').with({
            'section'           => 'files',
            'setting'           => 'path',
        ...
        it do
          is_expected.to contain_ini_setting('/etc/puppetlabs/puppet/fileserver.conf files allow').with({
            'section' => 'files',
            'setting' => 'allow',
            'value' => '*',
            'path' => '/etc/puppetlabs/puppet/fileserver.conf',
        ...
        it do
          is_expected.to contain_puppet_authorization__rule('fileserver_files').with({
            'match_request_path'   => '^/file_(metadata|content)s?/files/',
            'match_request_type'   => 'regex',
            'match_request_method' => %w(get post),
            'allow'                => '*',
            'sort_order'           => 300,
            'path'                 => '/etc/puppetlabs/puppetserver/conf.d/auth.conf',
          })
        end
        it { is_expected.to contain_puppet_authorization__rule('fileserver_files').that_notifies('Service[puppetserver]') }

        # Miles fileserver config
        it do
          is_expected.to contain_ini_setting('/etc/puppetlabs/puppet/fileserver.conf miles path').with({
            'section'           => 'miles',
            'setting'           => 'path',
        ...
        it do
          is_expected.to contain_ini_setting('/etc/puppetlabs/puppet/fileserver.conf miles allow').with({
            'section' => 'miles',
            'setting' => 'allow',
            'value' => '*',
            'path' => '/etc/puppetlabs/puppet/fileserver.conf',
        ...
        it do
          is_expected.to contain_puppet_authorization__rule('fileserver_miles').with({
        ...
        it do
          is_expected.to contain_puppet_authorization__rule('fileserver_miles').that_notifies('Service[puppetserver]')
        end
